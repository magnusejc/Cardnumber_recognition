...
transform = transforms.Compose(
    [
        transforms.Resize((150, 320)),
        transforms.RandomCrop((130, 300)),
        transforms.ToTensor(),
...
train_set = DigitDataset("", "train.csv", transform=transform)
validation_set = DigitDataset("", 'validation.csv', transform=transform)
